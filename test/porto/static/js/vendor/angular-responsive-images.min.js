(function () {
	...
	app.directive('bhSrcResponsive', ['presetMediaQueries', '$timeout',
		function (presetMediaQueries, $timeout) {
			return {
				restrict: 'A',
				priority: 100,
				link: function (scope, elm, attrs) {

					var justUseTheBigOne = false;

					// Double-check that the matchMedia function matchMedia exists
					if (typeof (matchMedia) !== 'function') {
						//throw "Function 'matchMedia' does not exist";
						justUseTheBigOne = true;
					}
					...
					function updateFromQuery(querySets) {
						...
						if (!waiting) {
							$timeout(function () {
								...
								if( justUseTheBigOne === true){

									//alert('oh hai marc!');

									setSrc(querySets[querySets.length-1][1]);
